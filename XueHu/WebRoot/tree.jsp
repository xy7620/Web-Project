...
var treeMenu = [
	{ level:1, name:"占座管理"},
	{ level:2, name:"占座列表", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:1, name:"自习管理"},
	{ level:2, name:"自习列表", ico:"images/icon_default.gif",link:"role_list.html"},
	{ level:1, name:"交流管理"},
	{ level:2, name:"学习交流", ico:"images/icon_default.gif",link:"news_list.html"},
	{ level:2, name:"生活娱乐", ico:"images/icon_default.gif",link:"bulletin_list.html"},
	{ level:1, name:"学习管家", ico:"images/icon_default.gif"},
	{ level:1, name:"书店", ico:"images/icon_default.gif",link:"complaint_list.html"}
];
</script>
<style>
* {
